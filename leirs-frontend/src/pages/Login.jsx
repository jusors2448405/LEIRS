...
const Login = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Step 6: Pass profile to parent (App.jsx will store in state)
      onLogin(profile)

      // Step 7: Route based on role - each role gets its own dashboard
      // LEIRS REVISE: Only 6 module-specific admin roles are supported
      switch (profile.role) {
        case 'system_admin':
